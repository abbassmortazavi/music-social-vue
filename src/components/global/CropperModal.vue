          ...
          <div class="bg-white px-4 pt-5 pb-4 p-6">
            <div class="flex items-center">
              <div class="mt-3 text-left ">
                <h3 class="text-2xl font-medium loading-6 text-gray-900">Crop Image</h3>
              ...
              <div class="pb-3 flex flex-row reverse px-4">
                <button v-if="uploadedImage" @click="crop" type="button" class="
                  inline-flex
                  w-full
                  justify-center
                  rounded-md
